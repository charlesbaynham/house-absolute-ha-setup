...
- **Extended Mode**: Does not timeout; plays a reminder TTS every 5 minutes; single press turns it OFF.
...
- Accumulators: add 1 minute per minute while `chore_mode_*` is ON.
